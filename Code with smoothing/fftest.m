function [freq,PSD1,Residuals]=fftest(Sevenday_model,Aggregated_data,dtv)
%%
...
plot(Residuals,'r')
hold on
plot (Aggregated_data(1:N),'b')
plot(Sevenday_model(1:N),'m')
hold off
title ('Data and Residuals','FontSize',18)
legend ('Residual' ,'Data','Barton Model','FontSize',14)
...
Fs=672;%sampling frequency: 168 samples in a single time unit (1344 hours/month)
